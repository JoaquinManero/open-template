...
import { LampDemo } from "./cards/lamp";
        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-400">
              Descubre cómo el compromiso, la guía personalizada y la motivación
              constante han cambiado vidas. Prepárate para inspirarte y
              visualizar tu propio viaje hacia el éxito
            </p>
          </div>
          <LampDemo />
